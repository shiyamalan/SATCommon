...
/**
 * Maintains dependency specific information, it maintains dependency between class as well as interface 
 * 
 * {@link Dependencies#taget_id} - keeps the target id, it may be a class object id or interface object id
 * {@link Dependencies#source_id} - keeps the source id, it may be a class object id or interface object id
 * 
 * @author SRatnavel
 * @since 1.0
 * @version 1.0
